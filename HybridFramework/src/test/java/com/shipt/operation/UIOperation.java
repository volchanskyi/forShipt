...
public class UIOperation {
	...
	case "NGCLICK":
	    ...
	    create.moveToElement(driver.findElements(this.getObject(p, objectName, objectType)).get(0))
	...
	case "SCROLLINTOVIEW":
	    ...
	    builder.moveToElement(driver.findElements(this.getObject(p, objectName, objectType)).get(0)).build()
		    .perform();
	    break;
	...
	case "VERIFYITEMS":
	    ...
	    wait.until(ExpectedConditions.visibilityOfElementLocated(this.getObject(p, objectName, objectType)));
	    // String item = null;
	    List<WebElement> allElement = driver.findElements(this.getObject(p, objectName, objectType));
	...
	case "CLOSEMODAL":
	    ...
	    build.moveToElement(driver.findElements(this.getObject(p, objectName, objectType)).get(0)).click().build()
		    .perform();
